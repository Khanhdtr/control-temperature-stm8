      ...
      0090E6 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      0090E7                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      0090E7 AE 53 47         [ 2]   71 	ldw	x, #0x5347
      0090EA 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      0090EC F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      0090ED AE 53 48         [ 2]   75 	ldw	x, #0x5348
      0090F0 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      0090F2 F7               [ 1]   77 	ld	(x), a
      0090F3 81               [ 4]   78 	ret
      ...
      009116 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      009117                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      009117 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      009119 43               [ 1]  134 	cpl	a
      00911A AE 53 44         [ 2]  135 	ldw	x, #0x5344
      00911D F7               [ 1]  136 	ld	(x), a
      00911E 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      00911F                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      00911F 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      009121 43               [ 1]  145 	cpl	a
      009122 AE 53 44         [ 2]  146 	ldw	x, #0x5344
      009125 F7               [ 1]  147 	ld	(x), a
      009126 81               [ 4]  148 	ret
                                    149 	.area CODE
