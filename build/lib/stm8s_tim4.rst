      ...
      008727 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      008728                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      008728 AE 53 47         [ 2]   71 	ldw	x, #0x5347
      00872B 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      00872D F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      00872E AE 53 48         [ 2]   75 	ldw	x, #0x5348
      008731 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      008733 F7               [ 1]   77 	ld	(x), a
      008734 81               [ 4]   78 	ret
      ...
      008757 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      008758                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      008758 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      00875A 43               [ 1]  134 	cpl	a
      00875B AE 53 44         [ 2]  135 	ldw	x, #0x5344
      00875E F7               [ 1]  136 	ld	(x), a
      00875F 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      008760                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      008760 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      008762 43               [ 1]  145 	cpl	a
      008763 AE 53 44         [ 2]  146 	ldw	x, #0x5344
      008766 F7               [ 1]  147 	ld	(x), a
      008767 81               [ 4]  148 	ret
                                    149 	.area CODE
