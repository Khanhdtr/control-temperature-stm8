      ...
      008990 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      008991                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      008991 AE 53 47         [ 2]   71 	ldw	x, #0x5347
      008994 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      008996 F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      008997 AE 53 48         [ 2]   75 	ldw	x, #0x5348
      00899A 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      00899C F7               [ 1]   77 	ld	(x), a
      00899D 81               [ 4]   78 	ret
      ...
      0089C0 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      0089C1                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      0089C1 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      0089C3 43               [ 1]  134 	cpl	a
      0089C4 AE 53 44         [ 2]  135 	ldw	x, #0x5344
      0089C7 F7               [ 1]  136 	ld	(x), a
      0089C8 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      0089C9                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      0089C9 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      0089CB 43               [ 1]  145 	cpl	a
      0089CC AE 53 44         [ 2]  146 	ldw	x, #0x5344
      0089CF F7               [ 1]  147 	ld	(x), a
      0089D0 81               [ 4]  148 	ret
                                    149 	.area CODE
