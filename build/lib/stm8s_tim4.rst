      ...
      0086DC 81               [ 4]   64 	ret
                                     ...
                                     68 ;	-----------------------------------------
      0086DD                         69 _TIM4_TimeBaseInit:
                                     70 ;	lib/stm8s_tim4.c: 26: TIM4->PSCR = (uint8_t)(TIM4_Prescaler);
      0086DD AE 53 47         [ 2]   71 	ldw	x, #0x5347
      0086E0 7B 03            [ 1]   72 	ld	a, (0x03, sp)
      0086E2 F7               [ 1]   73 	ld	(x), a
                                     74 ;	lib/stm8s_tim4.c: 28: TIM4->ARR = (uint8_t)(TIM4_Period);
      0086E3 AE 53 48         [ 2]   75 	ldw	x, #0x5348
      0086E6 7B 04            [ 1]   76 	ld	a, (0x04, sp)
      0086E8 F7               [ 1]   77 	ld	(x), a
      0086E9 81               [ 4]   78 	ret
      ...
      00870C 81               [ 4]  126 	ret
                                    ...
                                    130 ;	-----------------------------------------
      00870D                        131 _TIM4_ClearFlag:
                                    132 ;	lib/stm8s_tim4.c: 67: TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
      00870D 7B 03            [ 1]  133 	ld	a, (0x03, sp)
      00870F 43               [ 1]  134 	cpl	a
      008710 AE 53 44         [ 2]  135 	ldw	x, #0x5344
      008713 F7               [ 1]  136 	ld	(x), a
      008714 81               [ 4]  137 	ret
                                    138 ;	lib/stm8s_tim4.c: 70: void TIM4_ClearITPendingBit(TIM4_IT_TypeDef TIM4_IT)
                                    139 ;	-----------------------------------------
                                    140 ;	 function TIM4_ClearITPendingBit
                                    141 ;	-----------------------------------------
      008715                        142 _TIM4_ClearITPendingBit:
                                    143 ;	lib/stm8s_tim4.c: 73: TIM4->SR1 = (uint8_t)(~TIM4_IT);
      008715 7B 03            [ 1]  144 	ld	a, (0x03, sp)
      008717 43               [ 1]  145 	cpl	a
      008718 AE 53 44         [ 2]  146 	ldw	x, #0x5344
      00871B F7               [ 1]  147 	ld	(x), a
      00871C 81               [ 4]  148 	ret
                                    149 	.area CODE
