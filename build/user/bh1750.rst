      ...
      0080D5 CD 00 00         [ 4]  114 	call	_I2C_GenerateSTART
      ...
      0080DD CD 00 00         [ 4]  120 	call	_I2C_CheckEvent
      ...
      0080E8 CD 00 00         [ 4]  127 	call	_I2C_Send7bitAddress
      ...
      0080F0 CD 00 00         [ 4]  133 	call	_I2C_CheckEvent
      ...
      0080FA CD 00 00         [ 4]  140 	call	_I2C_SendData
      ...
      008102 CD 00 00         [ 4]  146 	call	_I2C_CheckEvent
      ...
      00810B CD 00 00         [ 4]  152 	call	_I2C_GenerateSTOP
      ...
      008118 1F 04            [ 2]  167 	ldw	(0x04, sp), x
      00811A 1E 04            [ 2]  168 	ldw	x, (0x04, sp)
      00811C 7F               [ 1]  169 	clr	(x)
      00811D 1E 04            [ 2]  170 	ldw	x, (0x04, sp)
      00811F 5C               [ 2]  171 	incw	x
      008120 1F 06            [ 2]  172 	ldw	(0x06, sp), x
      008122 1E 06            [ 2]  173 	ldw	x, (0x06, sp)
      ...
      008129 CD 00 00         [ 4]  179 	call	_I2C_GetFlagStatus
      ...
      008132 CD 00 00         [ 4]  185 	call	_I2C_GenerateSTART
      ...
      00813A CD 00 00         [ 4]  191 	call	_I2C_CheckEvent
      ...
      008145 CD 00 00         [ 4]  198 	call	_I2C_Send7bitAddress
      ...
      00814D CD 00 00         [ 4]  204 	call	_I2C_CheckEvent
      ...
      00815C CD 00 00         [ 4]  215 	call	_I2C_CheckEvent
      ...
      008169 CD 00 00         [ 4]  224 	call	_I2C_AcknowledgeConfig
      00816C 84               [ 1]  225 	pop	a
                                    226 ;	user/bh1750.c: 57: I2C_GenerateSTOP(ENABLE);   
      00816D 4B 01            [ 1]  227 	push	#0x01
      00816F CD 00 00         [ 4]  228 	call	_I2C_GenerateSTOP
      ...
      00817C 72 FB 04         [ 2]  238 	addw	x, (0x04, sp)
      00817F 89               [ 2]  239 	pushw	x
      008180 CD 00 00         [ 4]  240 	call	_I2C_ReceiveData
      ...
      00818B 1E 06            [ 2]  249 	ldw	x, (0x06, sp)
      00818D F6               [ 1]  250 	ld	a, (x)
      00818E 95               [ 1]  251 	ld	xh, a
      00818F 4F               [ 1]  252 	clr	a
      008190 0F 0A            [ 1]  253 	clr	(0x0a, sp)
      008192 16 04            [ 2]  254 	ldw	y, (0x04, sp)
      008194 90 F6            [ 1]  255 	ld	a, (y)
      008196 0F 0B            [ 1]  256 	clr	(0x0b, sp)
      008198 1A 0A            [ 1]  257 	or	a, (0x0a, sp)
      00819A 97               [ 1]  258 	ld	xl, a
      00819B 9E               [ 1]  259 	ld	a, xh
      00819C 1A 0B            [ 1]  260 	or	a, (0x0b, sp)
